      ...
      <header className="h-16 bg-white border-b border-[#E2E8F0] flex items-center justify-between px-6 sticky top-0 z-50">
        ...
        {student && (
          <div className="flex items-center gap-2">
            <Link
              to="/learn"
              className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-[#64748B] hover:bg-[#F1F5F9] hover:text-[#0F172A] transition-colors no-underline"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="p-2 rounded-lg text-[#64748B] hover:bg-[#F1F5F9] hover:text-[#EF4444] transition-colors"
                title="Sign out"
              >
